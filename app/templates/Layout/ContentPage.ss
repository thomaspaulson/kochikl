    ...
    <div class="searchform-wrapper">
        <div class="row">
            ...
            <h6 class="search-title hide-for-large">Search <i class="down"></i></h6>
    ...
    <div class="heading-bar">
        <div class="row">
            <div class="small-12 medium-8 large-8 medium-centered large-centered columns">
            	<h1><% if $MenuTitle %>$MenuTitle<% else %>$Title<% end_if %></h1>            
                <% if $Summary %>$Summary<% else %><p>$Excerpt(20)<p><% end_if %>                    
                <div class="addthis_inline_share_toolbox"></div>
                <%-- 
                <div class="menu-centered">
                    <ul class="menu">
                        <li><a href="#enquiry_form" class="button contact_enquiry">Enquiry</a></li>
